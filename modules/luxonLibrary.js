    ...
    var [n, s, i, a, e, o] = (
      r.formatToParts
        ...
        : function (e, t) {
          ...
          var [, n, s, i, e, t, r] = /(\d+)\/(\d+)\/(\d+),? (\d+):(\d+):(\d+)/.exec(r);
          return [i, n, s, e, t, r];
        }
    )(r, t);
    var r = +t;
...
class Ye {
  ...
  eras(e, t = !0) {
    return We(this, e, t, ye, () => {
      ...
      return (
        this.eraCache[e]
          || (this.eraCache[e] = [Rr.utc(-40, 1, 1), Rr.utc(2017, 1, 1)].map((e) => this.extract(e, t, 'era'))),
        this.eraCache[e]
      );
    });
  }
...
const lt = /^-?P(?:(?:(-?\d{1,9}(?:\.\d{1,9})?)Y)?(?:(-?\d{1,9}(?:\.\d{1,9})?)M)?(?:(-?\d{1,9}(?:\.\d{1,9})?)W)?(?:(-?\d{1,9}(?:\.\d{1,9})?)D)?(?:T(?:(-?\d{1,9}(?:\.\d{1,9})?)H)?(?:(-?\d{1,9}(?:\.\d{1,9})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,9}))?S)?)?)$/;
function ct(e) {
...
const mt = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|(?:([+-]\d\d)(\d\d)))$/;
function ft(e) {
...
const yt = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d\d) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d\d):(\d\d):(\d\d) GMT$/;
const gt = /^(Monday|Tuesday|Wedsday|Thursday|Friday|Saturday|Sunday), (\d\d)-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d\d) (\d\d):(\d\d):(\d\d) GMT$/;
const wt = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ( \d|\d\d) (\d\d):(\d\d):(\d\d) (\d{4})$/;
function vt(e) {
  var [, t, r, n, s, i, a, e] = e;
...
class $t {
  ...
  plus(e) {
    ...
    const r = {};
    for (const n of At) { (A(t.values, n) || A(this.values, n)) && (r[n] = t.get(n) + this.get(n)); }
  ...
  shiftTo(...e) {
    ...
    for (const a of At) {
      if (e.indexOf(a) >= 0) {
        ...
        for (const u in n) { At.indexOf(u) > At.indexOf(a) && Ut(this.matrix, n, u, t, a); }
      } else L(n[a]) && (r[a] = n[a]);
    }
...
function lr(e, t) {
  ...
  const s = n.formatDateTimeParts(((ur = ur || Rr.fromMillis(1555555555555)), ur));
...
class Rr {
  ...
  static min(...e) {
    if (!e.every(Rr.isDateTime)) { throw new o('min requires all arguments be DateTimes'); }
    return q(e, (e) => e.valueOf(), Math.min);
  }

  static max(...e) {
    if (!e.every(Rr.isDateTime)) { throw new o('max requires all arguments be DateTimes'); }
